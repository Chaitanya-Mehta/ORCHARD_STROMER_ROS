...
#                    print("Hold position")            
                ...
                kit.servo[8].angle=absevent.event.value*(180/255)
                print("ABS_X, TURN ="+str(absevent.event.value*(180/255)))
            elif ecodes.bytype[absevent.event.type][absevent.event.code] == "ABS_Y":
                kit.servo[9].angle=absevent.event.value*(180/255)
                print("ABS_Y , UP="+str(absevent.event.value*(180/255)))
            elif ecodes.bytype[absevent.event.type][absevent.event.code] == "ABS_RX":
                kit.servo[10].angle=absevent.event.value*(180/255)
                print("ABS_RX, TWIST ="+str(absevent.event.value*(180/255)))            
                pass
